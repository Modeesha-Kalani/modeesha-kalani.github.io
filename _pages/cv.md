...
Skills
======
* **Cloud & DevOps:** AWS, CloudFormation, IaC, CI/CD, GitLab CI, Terraform, SRE, managed services pipelines
* **Architecture:** Solution Architecture, scalable and compliant cloud solutions, multi-account AWS
* **Security & Compliance:** Divvy IaC scanning, Pearson compliance, backup vaults, bunker account backups
* **Programming:** Python
* **Soft Skills:** Early adopter, future trends awareness, cross-team collaboration, technical interviewing
