...
<div class="pretty-card">
  <p class="card-title">SLIIT</p>

  <p class="card-subtitle">Master of Science (MSc), Artificial Intelligence</p>
...
<div class="pretty-card">
  <p class="card-title">Sivali Central College, Rathnapura</p>
  <p class="card-meta">January 2007 – August 2016</p>
  <ul>
    <li>9A passes (Highest Pass) for Ordinary Level Examination (2013)</li>
    <li>Advanced Level (2016) completed in Biological Sciences Stream</li>
    <li>Senior Prefect (2015–2016)</li>
  </ul>
</div>
...
<div class="pretty-card">
  ...
  <ul class="pill-list">
    ...
    <li>Sinhalese — Professional Working</li>
  </ul>
</div>
